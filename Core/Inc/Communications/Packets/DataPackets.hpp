...
public:
    static HeapPacket *pwm_packet;
    static HeapPacket *Batteries_Voltage;
    static HeapPacket *Current_sensors;
    static HeapPacket *StateMachine_states;
    static HeapPacket *Speetec_data;
    static HeapPacket *Speed_data;
    static HeapPacket *GateDriverReporting;
